...
func TestClient_GetMachine(t *testing.T) {
	...
	httpmock.RegisterResponder(
		...
		httpmock.NewBytesResponder(200, mockData(t, "machines__get__systemid-e37xxm.json")),
	)
...
func TestClient_AllocateMachine(t *testing.T) {
	...
	t.Run("with-az", func(t *testing.T) {
		...
		httpmock.RegisterResponder(
			http.MethodPost,
			"http://maas.test/api/2.0/machines/",
			httpmock.NewBytesResponder(200, mockData(t, "machines__create__systemid-a12b3c.json")),
		)
...
func TestClient_DeployMachine(t *testing.T) {
	...
	t.Run("simple", func(t *testing.T) {
		...
		httpmock.RegisterResponder(
			http.MethodPut,
			"http://maas.test/api/2.0/machines/a12b3c/",
			httpmock.NewBytesResponder(200, mockData(t, "machines__update__systemid-a12b3c.json")),
		)

		httpmock.RegisterResponder(
			http.MethodPost,
			"http://maas.test/api/2.0/machines/a12b3c/",
			httpmock.NewBytesResponder(200, mockData(t, "machines__deploy__systemid-a12b3c.json")),
		)
...
func TestClient_UpdateMachine(t *testing.T) {
	...
	httpmock.RegisterResponder(
		http.MethodPut,
		"http://maas.test/api/2.0/machines/e37xxm/",
		httpmock.NewBytesResponder(200, mockData(t, "machines__update__systemid-e37xxm.json")),
	)
